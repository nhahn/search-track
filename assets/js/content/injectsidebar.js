...
if (typeof injected === 'undefined') {
  ...
  var $app = $('<!-- INJECTED SIDEBAR --> <iframe id="injectedsidebar" style="position:fixed;z-index:2147483645;height:28px;bottom:0;width:100%;font-family:arial;padding:0;background-color:rgba(221,219,221,0.9);border:none;border-top:1px solid rgb(103,103,103);" sandbox="allow-same-origin allow-scripts allow-popups" src="' + chrome.extension.getURL('/html/sidebar.html') + '"></iframe> <!-- END SIDEBAR-->').appendTo('html');
